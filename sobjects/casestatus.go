// This file was generated for SObject CaseStatus, API Version v43.0 at 2018-07-30 03:48:03.391644464 -0400 EDT m=+49.736117131
...
func (t *CaseStatus) ApiName() string {
	return "CaseStatus"
}

func (t *CaseStatus) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("CaseStatus #%s - %s\n", t.Id, t.Name))
...
type CaseStatusQueryResponse struct {
	BaseQuery
	Records []CaseStatus `json:"Records" force:"records"`
}
