// This file was generated for SObject CaseFeed, API Version v43.0 at 2018-07-30 03:47:45.642393794 -0400 EDT m=+31.986200439
...
func (t *CaseFeed) ApiName() string {
	return "CaseFeed"
}

func (t *CaseFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("CaseFeed #%s - %s\n", t.Id, t.Name))
...
type CaseFeedQueryResponse struct {
	BaseQuery
	Records []CaseFeed `json:"Records" force:"records"`
}
