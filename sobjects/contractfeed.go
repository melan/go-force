// This file was generated for SObject ContractFeed, API Version v43.0 at 2018-07-30 03:47:21.361451727 -0400 EDT m=+7.704347254
...
func (t *ContractFeed) ApiName() string {
	return "ContractFeed"
}

func (t *ContractFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("ContractFeed #%s - %s\n", t.Id, t.Name))
...
type ContractFeedQueryResponse struct {
	BaseQuery
	Records []ContractFeed `json:"Records" force:"records"`
}
