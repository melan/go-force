// This file was generated for SObject AuraDefinitionBundle, API Version v43.0 at 2018-07-30 03:48:11.332341743 -0400 EDT m=+57.677112376
...
func (t *AuraDefinitionBundle) ApiName() string {
	return "AuraDefinitionBundle"
}

func (t *AuraDefinitionBundle) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("AuraDefinitionBundle #%s - %s\n", t.Id, t.Name))
...
type AuraDefinitionBundleQueryResponse struct {
	BaseQuery
	Records []AuraDefinitionBundle `json:"Records" force:"records"`
}
