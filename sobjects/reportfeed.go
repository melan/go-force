// This file was generated for SObject ReportFeed, API Version v43.0 at 2018-07-30 03:48:10.951423633 -0400 EDT m=+57.296179973
...
func (t *ReportFeed) ApiName() string {
	return "ReportFeed"
}

func (t *ReportFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("ReportFeed #%s - %s\n", t.Id, t.Name))
...
type ReportFeedQueryResponse struct {
	BaseQuery
	Records []ReportFeed `json:"Records" force:"records"`
}
