// This file was generated for SObject SolutionFeed, API Version v43.0 at 2018-07-30 03:47:33.62417838 -0400 EDT m=+19.967534054
...
func (t *SolutionFeed) ApiName() string {
	return "SolutionFeed"
}

func (t *SolutionFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("SolutionFeed #%s - %s\n", t.Id, t.Name))
...
type SolutionFeedQueryResponse struct {
	BaseQuery
	Records []SolutionFeed `json:"Records" force:"records"`
}
