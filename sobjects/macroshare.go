// This file was generated for SObject MacroShare, API Version v43.0 at 2018-07-30 03:47:41.687464947 -0400 EDT m=+28.031123187
...
func (t *MacroShare) ApiName() string {
	return "MacroShare"
}

func (t *MacroShare) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("MacroShare #%s - %s\n", t.Id, t.Name))
...
type MacroShareQueryResponse struct {
	BaseQuery
	Records []MacroShare `json:"Records" force:"records"`
}
