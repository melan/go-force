// This file was generated for SObject LookedUpFromActivity, API Version v43.0 at 2018-07-30 03:47:19.537601504 -0400 EDT m=+5.880428592
...
func (t *LookedUpFromActivity) ApiName() string {
	return "LookedUpFromActivity"
}

func (t *LookedUpFromActivity) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("LookedUpFromActivity #%s - %s\n", t.Id, t.Name))
...
type LookedUpFromActivityQueryResponse struct {
	BaseQuery
	Records []LookedUpFromActivity `json:"Records" force:"records"`
}
