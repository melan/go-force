// This file was generated for SObject OrderItemFeed, API Version v43.0 at 2018-07-30 03:47:55.35913009 -0400 EDT m=+41.703301345
...
func (t *OrderItemFeed) ApiName() string {
	return "OrderItemFeed"
}

func (t *OrderItemFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("OrderItemFeed #%s - %s\n", t.Id, t.Name))
...
type OrderItemFeedQueryResponse struct {
	BaseQuery
	Records []OrderItemFeed `json:"Records" force:"records"`
}
