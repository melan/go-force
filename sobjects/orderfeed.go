// This file was generated for SObject OrderFeed, API Version v43.0 at 2018-07-30 03:47:20.217623919 -0400 EDT m=+6.560476525
...
func (t *OrderFeed) ApiName() string {
	return "OrderFeed"
}

func (t *OrderFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("OrderFeed #%s - %s\n", t.Id, t.Name))
...
type OrderFeedQueryResponse struct {
	BaseQuery
	Records []OrderFeed `json:"Records" force:"records"`
}
