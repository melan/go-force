// This file was generated for SObject ContactFeed, API Version v43.0 at 2018-07-30 03:47:16.134819284 -0400 EDT m=+2.477518686
...
func (t *ContactFeed) ApiName() string {
	return "ContactFeed"
}

func (t *ContactFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("ContactFeed #%s - %s\n", t.Id, t.Name))
...
type ContactFeedQueryResponse struct {
	BaseQuery
	Records []ContactFeed `json:"Records" force:"records"`
}
