// This file was generated for SObject TopicFeed, API Version v43.0 at 2018-07-30 03:47:31.719529879 -0400 EDT m=+18.062814083
...
func (t *TopicFeed) ApiName() string {
	return "TopicFeed"
}

func (t *TopicFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("TopicFeed #%s - %s\n", t.Id, t.Name))
...
type TopicFeedQueryResponse struct {
	BaseQuery
	Records []TopicFeed `json:"Records" force:"records"`
}
