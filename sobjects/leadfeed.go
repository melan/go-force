// This file was generated for SObject LeadFeed, API Version v43.0 at 2018-07-30 03:47:28.398719167 -0400 EDT m=+14.741878761
...
func (t *LeadFeed) ApiName() string {
	return "LeadFeed"
}

func (t *LeadFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("LeadFeed #%s - %s\n", t.Id, t.Name))
...
type LeadFeedQueryResponse struct {
	BaseQuery
	Records []LeadFeed `json:"Records" force:"records"`
}
