// This file was generated for SObject TaskFeed, API Version v43.0 at 2018-07-30 03:47:57.198798443 -0400 EDT m=+43.543038730
...
func (t *TaskFeed) ApiName() string {
	return "TaskFeed"
}

func (t *TaskFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("TaskFeed #%s - %s\n", t.Id, t.Name))
...
type TaskFeedQueryResponse struct {
	BaseQuery
	Records []TaskFeed `json:"Records" force:"records"`
}
