...
func (t *UserFeed) ApiName() string {
	return "UserFeed"
}

func (t *UserFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("UserFeed #%s - %s\n", t.Id, t.Name))
...
type UserFeedQueryResponse struct {
	BaseQuery
	Records []UserFeed `json:"Records" force:"records"`
}
