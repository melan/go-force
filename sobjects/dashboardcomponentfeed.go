// This file was generated for SObject DashboardComponentFeed, API Version v43.0 at 2018-07-30 03:47:46.750411465 -0400 EDT m=+33.094259687
...
func (t *DashboardComponentFeed) ApiName() string {
	return "DashboardComponentFeed"
}

func (t *DashboardComponentFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("DashboardComponentFeed #%s - %s\n", t.Id, t.Name))
...
type DashboardComponentFeedQueryResponse struct {
	BaseQuery
	Records []DashboardComponentFeed `json:"Records" force:"records"`
}
