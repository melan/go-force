// This file was generated for SObject ActivityHistory, API Version v43.0 at 2018-07-30 03:48:00.258956569 -0400 EDT m=+46.603311685
...
func (t *ActivityHistory) ApiName() string {
	return "ActivityHistory"
}

func (t *ActivityHistory) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("ActivityHistory #%s - %s\n", t.Id, t.Name))
...
type ActivityHistoryQueryResponse struct {
	BaseQuery
	Records []ActivityHistory `json:"Records" force:"records"`
}
