// This file was generated for SObject CollaborationGroupFeed, API Version v43.0 at 2018-07-30 03:47:15.642110714 -0400 EDT m=+1.984791627
...
func (t *CollaborationGroupFeed) ApiName() string {
	return "CollaborationGroupFeed"
}

func (t *CollaborationGroupFeed) String() string {
	builder := strings.Builder{}
	builder.WriteString(fmt.Sprintf("CollaborationGroupFeed #%s - %s\n", t.Id, t.Name))
...
type CollaborationGroupFeedQueryResponse struct {
	BaseQuery
	Records []CollaborationGroupFeed `json:"Records" force:"records"`
}
